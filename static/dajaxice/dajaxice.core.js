...
var Dajaxice = {
    mongobase: {
    // not working
    // still_available_ajax: function(callback_function, argv, custom_settings){
    //     return Dajaxice.call('mongobase.still_available_ajax', 'POST', callback_function, argv, custom_settings);
    // },
    // not working
    // load_qualities_ajax: function(callback_function, argv, custom_settings){
    //     return Dajaxice.call('mongobase.load_qualities_ajax', 'POST', callback_function, argv, custom_settings);
    // },
    // not working
    // update_db_ajax: function(callback_function, argv, custom_settings){
    //     return Dajaxice.call('mongobase.update_db_ajax', 'POST', callback_function, argv, custom_settings);
    // },
// // not working
//     load_defitems_ajax: function(callback_function, argv, custom_settings){
//         return Dajaxice.call('mongobase.load_defitems_ajax', 'POST', callback_function, argv, custom_settings);
//     },
// not working
    // get_progress_ajax: function(callback_function, argv, custom_settings){
    //     return Dajaxice.call('mongobase.get_progress_ajax', 'POST', callback_function, argv, custom_settings);
    // },
// not working
    // default_items_detail_ajax: function(callback_function, argv, custom_settings){
    //     return Dajaxice.call('mongobase.default_items_detail_ajax', 'POST', callback_function, argv, custom_settings);
    // },

// not working
    // owner_info_ajax: function(callback_function, argv, custom_settings){
    //     return Dajaxice.call('mongobase.owner_info_ajax', 'POST', callback_function, argv, custom_settings);
    // },
// not working
    // save_quality_ajax: function(callback_function, argv, custom_settings){
    //     return Dajaxice.call('mongobase.save_quality_ajax', 'POST', callback_function, argv, custom_settings);
    // },

// not working
    // load_effects_ajax: function(callback_function, argv, custom_settings){
    //     return Dajaxice.call('mongobase.load_effects_ajax', 'POST', callback_function, argv, custom_settings);
    // },
// not working

// not working
    // log_ajax: function(callback_function, argv, custom_settings){
    //     return Dajaxice.call('mongobase.log_ajax', 'POST', callback_function, argv, custom_settings);
    // },

// not working
    // save_effect_ajax: function(callback_function, argv, custom_settings){
    //     return Dajaxice.call('mongobase.save_effect_ajax', 'POST', callback_function, argv, custom_settings);
    // },
// not working
    // stats_ajax: function(callback_function, argv, custom_settings){
    //     return Dajaxice.call('mongobase.stats_ajax', 'POST', callback_function, argv, custom_settings);
    // },
// not working
    // filter_item_ajax: function(callback_function, argv, custom_settings){
    //     return Dajaxice.call('mongobase.filter_item_ajax', 'POST', callback_function, argv, custom_settings);
    // },
// not working
    // save_item_ajax: function(callback_function, argv, custom_settings){
    //     return Dajaxice.call('mongobase.save_item_ajax', 'POST', callback_function, argv, custom_settings);
    // },



// not working
    get_item_stats_ajax: function(callback_function, argv, custom_settings){
        return Dajaxice.call('mongobase.get_item_stats_ajax', 'POST', callback_function, argv, custom_settings);
    },
// not working
    find_user_ajax: function(callback_function, argv, custom_settings){
        return Dajaxice.call('mongobase.find_user_ajax', 'POST', callback_function, argv, custom_settings);
    },
// not working
    save_user_ajax: function(callback_function, argv, custom_settings){
        return Dajaxice.call('mongobase.save_user_ajax', 'POST', callback_function, argv, custom_settings);
    },
    // works
    search_results_ajax: function(callback_function, argv, custom_settings){
        return Dajaxice.call('mongobase.search_results_ajax', 'POST', callback_function, argv, custom_settings);
    },
    filter_unusuals_ajax: function(callback_function, argv, custom_settings){
        return Dajaxice.call('mongobase.filter_unusuals_ajax', 'POST', callback_function, argv, custom_settings);
    },
    // works
    scanner_results_ajax: function(callback_function, argv, custom_settings){
        return Dajaxice.call('mongobase.scanner_results_ajax', 'POST', callback_function, argv, custom_settings);
    },
    // works
    save_blacklist_ajax: function(callback_function, argv, custom_settings){
        return Dajaxice.call('mongobase.save_blacklist_ajax', 'POST', callback_function, argv, custom_settings);
    },
    // works    
    scan_friends_ajax: function(callback_function, argv, custom_settings){
        return Dajaxice.call('mongobase.scan_friends_ajax', 'POST', callback_function, argv, custom_settings);
    },
    // works    
    send_data_ajax: function(callback_function, argv, custom_settings){
        return Dajaxice.call('mongobase.send_data_ajax', 'POST', callback_function, argv, custom_settings);
    },

    // works    
    load_names_ajax: function(callback_function, argv, custom_settings){
        return Dajaxice.call('mongobase.load_names_ajax', 'POST', callback_function, argv, custom_settings);
    },

    // works
    load_default_blacklist_ajax: function(callback_function, argv, custom_settings){
        return Dajaxice.call('mongobase.load_default_blacklist_ajax', 'POST', callback_function, argv, custom_settings);
    },
    // works 
    get_defitems_ajax: function(callback_function, argv, custom_settings){
        return Dajaxice.call('mongobase.get_defitems_ajax', 'POST', callback_function, argv, custom_settings);
    },
    // works
    filter_australiums_ajax: function(callback_function, argv, custom_settings){
        return Dajaxice.call('mongobase.filter_australiums_ajax', 'POST', callback_function, argv, custom_settings);
    },
    // works    
    get_team_names_ajax: function(callback_function, argv, custom_settings){
        return Dajaxice.call('mongobase.get_team_names_ajax', 'POST', callback_function, argv, custom_settings);
    },
    get_teams_ajax: function(callback_function, argv, custom_settings){
        return Dajaxice.call('mongobase.get_teams_ajax', 'POST', callback_function, argv, custom_settings);
    },
    filter_tourneys_ajax: function(callback_function, argv, custom_settings){
        return Dajaxice.call('mongobase.filter_tourneys_ajax', 'POST', callback_function, argv, custom_settings);
    },
